...
export async function getAllTasksLocal() { return (await db()).getAll("tasks") || []; }
...
export type OutboxOp = 
    ...
    export async function getOutbox() { return (await db()).getAll("outbox") || []; }
